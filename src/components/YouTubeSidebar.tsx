    ...
    return (
      <aside className="hidden md:flex w-18 bg-white border-r border-slate-200 flex-col items-center py-3 gap-6 shrink-0 select-none">
        <button
          ...
          className={`flex flex-col items-center gap-1 p-2.5 rounded-xl text-[11px] font-medium transition-colors cursor-pointer ${activeTab === "home" ? "text-blue-600 bg-blue-50" : "text-slate-600 hover:bg-slate-100"}`}
        >
        ...
        <button
          ...
          className={`flex flex-col items-center gap-1 p-2.5 rounded-xl text-[11px] font-medium transition-colors cursor-pointer ${activeTab === "explore" ? "text-blue-600 bg-blue-50" : "text-slate-600 hover:bg-slate-100"}`}
        >
        ...
        <button
          ...
          className={`flex flex-col items-center gap-1 p-2.5 rounded-xl text-[11px] font-medium transition-colors cursor-pointer ${activeTab === "profile" ? "text-blue-600 bg-blue-50" : "text-slate-600 hover:bg-slate-100"}`}
        >
  ...
  return (
    <aside className="hidden md:flex w-64 bg-white border-r border-slate-200 flex-col p-3 space-y-4 shrink-0 overflow-y-auto select-none">
      ...
      <div className="space-y-1">
        ...
        {[
          { name: "Comptabilité & Finance", icon: "📊" },
          { name: "Management & Leadership", icon: "👥" },
          { name: "Agence de Voyage & Tourisme", icon: "✈️" },
